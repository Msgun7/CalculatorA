...
//  Calculator1
//
//  Created by Jaegeon Yeon on 2021/07/28.
//
    ...
    func didTap(button: CalcButton) {
        ...
        case .add, .subtract, .multiply, .divide, .equal:
            if button == .add{
                ...
                case .multiply: self.value = "\(Double(runningValue) * Double(currentValue))"
                case .divide: self.value = "\(Double(runningValue) / Double(currentValue))"
